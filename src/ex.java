...
public class ex extends JFrame implements KeyListener{
    ...
    public ex() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("image/bear.png")); // 파비콘 위치
    ...
    public void paint(Graphics g) {
        switch (sel) {
            case 1:
                image = Toolkit.getDefaultToolkit().getImage("image/bear.png"); //고양이 이미지1
                break;
            case 2:
                image = Toolkit.getDefaultToolkit().getImage("image/bear.png"); //고양이 이미지2
                break;

            case 3:
                image = Toolkit.getDefaultToolkit().getImage("image/bear.png"); //고양이 이미지3
                break;

            case 4:
                image = Toolkit.getDefaultToolkit().getImage("image/bear.png"); //고양이 이미지4
                break;
        }
